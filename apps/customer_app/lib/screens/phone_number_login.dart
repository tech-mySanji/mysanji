  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is PhoneNumberLoginStartedState) {
                                    ...
                                    child: PrimaryButton(
                                      ...
                                      onPressed: () {
                                        if (_formKey.currentState!.validate()) {
                                          authBloc.add(
                                              PhoneNumberEnteredEvent("+91${_phoneNumberController.text}"));
                                        } else {
                                          print("Not Validated");
                                        }
                                      },
